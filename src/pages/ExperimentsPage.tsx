...
import { Plus, Beaker, Share2, Save, ChevronDown, ArrowRight, ArrowLeft } from "lucide-react";
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-card border border-border rounded-lg p-6 mb-8 shadow-sm">
              ...
              <div className="flex justify-between mt-6">
                ...
                variant="outline"
                onClick={() => {
                  if (currentStep === 0) setShowBuilder(false);else
          ...
          <div className="mt-12 border border-border rounded-lg p-6 text-center space-y-3 bg-card">
            ...
            <p className="text-lg font-display font-bold">🔜 Next: See how peers share learnings in Reflection Pods</p>
